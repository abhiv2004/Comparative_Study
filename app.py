...
def analyze():
    ...
    if file and allowed_file(file.filename):
        ...
        missing_value_before = df.isnull().sum().to_dict(),
        ...
        dataset_info = {
            ...
            'missing_values_before' :missing_value_before,
            'missing_values_after': processed_df.isnull().sum().to_dict(),
        ...
        #scatter_data = [{"x": actual.item(), "y": predicted.item()} for actual, predicted in zip(y, y_pred)]
